...
@Service
public class ClientSininstreAdminServiceImpl extends AbstractServiceImpl<ClientSininstre> implements ClientSininstreAdminService {

@Autowired
private ClientSininstreDao clientSininstreDao;

        @Autowired
        private SinistreAdminService sinistreService ;
        @Autowired
