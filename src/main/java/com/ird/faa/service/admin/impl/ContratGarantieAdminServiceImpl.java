...
@Service
public class ContratGarantieAdminServiceImpl extends AbstractServiceImpl<ContratGarantie> implements ContratGarantieAdminService {

@Autowired
private ContratGarantieDao contratGarantieDao;

        @Autowired
        private GarantieAdminService garantieService ;
        @Autowired
