...
import com.ird.faa.service.agent.facade.ClientSininstreAgentService;
        import com.ird.faa.service.agent.facade.SinistreAgentService;
...
@Service
public class ClientSininstreAgentServiceImpl extends AbstractServiceImpl<ClientSininstre> implements ClientSininstreAgentService {

@Autowired
private ClientSininstreDao clientSininstreDao;

        @Autowired
        private SinistreAgentService sinistreService ;
        @Autowired
        private QuittanceIndemniserAgentService quittanceIndemniserService ;
        @Autowired
