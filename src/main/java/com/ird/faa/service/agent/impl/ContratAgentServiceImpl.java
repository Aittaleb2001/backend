...
import com.ird.faa.service.agent.facade.ContratAgentService;
        ...
        import com.ird.faa.service.agent.facade.NatureContratAgentService;
        ...
        import com.ird.faa.service.agent.facade.ContratGarantieAgentService;
...
@Service
public class ContratAgentServiceImpl extends AbstractServiceImpl<Contrat> implements ContratAgentService {
...
private ContratDao contratDao;
        ...
        @Autowired
        private NatureContratAgentService natureContratService ;
        @Autowired
        private QuittancePrimeAgentService quittancePrimeService ;
        @Autowired
        private ClientAgentService clientService ;
        @Autowired
        private ContratGarantieAgentService contratGarantieService ;
