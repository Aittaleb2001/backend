...
import com.ird.faa.service.agent.facade.ContratGarantieAgentService;
        import com.ird.faa.service.agent.facade.GarantieAgentService;
...
@Service
public class ContratGarantieAgentServiceImpl extends AbstractServiceImpl<ContratGarantie> implements ContratGarantieAgentService {

@Autowired
private ContratGarantieDao contratGarantieDao;

        @Autowired
        private GarantieAgentService garantieService ;
        @Autowired
