...
@Service
public class SinistreAgentServiceImpl extends AbstractServiceImpl<Sinistre> implements SinistreAgentService {

@Autowired
private SinistreDao sinistreDao;

        @Autowired
        private TypeSinistreAgentService typeSinistreService ;
        @Autowired
