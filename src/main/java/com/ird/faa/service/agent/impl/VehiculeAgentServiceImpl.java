...
import com.ird.faa.service.agent.facade.VehiculeAgentService;
        import com.ird.faa.service.agent.facade.MarqueAgentService;
        import com.ird.faa.service.agent.facade.TypeVehiculeAgentService;
        import com.ird.faa.service.agent.facade.CarburantAgentService;
...
@Service
public class VehiculeAgentServiceImpl extends AbstractServiceImpl<Vehicule> implements VehiculeAgentService {

@Autowired
private VehiculeDao vehiculeDao;

        @Autowired
        private MarqueAgentService marqueService ;
        @Autowired
        private TypeVehiculeAgentService typeVehiculeService ;
        @Autowired
        private CarburantAgentService carburantService ;
        @Autowired
