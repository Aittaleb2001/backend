...
import com.ird.faa.service.chercheur.facade.ClientSininstreChercheurService;
        import com.ird.faa.service.chercheur.facade.SinistreChercheurService;
        import com.ird.faa.service.chercheur.facade.QuittanceIndemniserChercheurService;
...
@Service
public class ClientSininstreChercheurServiceImpl extends AbstractServiceImpl<ClientSininstre> implements ClientSininstreChercheurService {

@Autowired
private ClientSininstreDao clientSininstreDao;

        @Autowired
        private SinistreChercheurService sinistreService ;
        @Autowired
        private QuittanceIndemniserChercheurService quittanceIndemniserService ;
        @Autowired
