...
import com.ird.faa.service.chercheur.facade.SinistreChercheurService;
        import com.ird.faa.service.chercheur.facade.TypeSinistreChercheurService;
...
@Service
public class SinistreChercheurServiceImpl extends AbstractServiceImpl<Sinistre> implements SinistreChercheurService {

@Autowired
private SinistreDao sinistreDao;

        @Autowired
        private TypeSinistreChercheurService typeSinistreService ;
        @Autowired
