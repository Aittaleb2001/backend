...
import com.ird.faa.service.gestionnaire.facade.ClientGestionnaireService;
        ...
        import com.ird.faa.service.gestionnaire.facade.TypeClientGestionnaireService;
...
@Service
public class ClientGestionnaireServiceImpl extends AbstractServiceImpl<Client> implements ClientGestionnaireService {

@Autowired
private ClientDao clientDao;

        @Autowired
        private ClientSininstreGestionnaireService clientSininstreService ;
        @Autowired
        private VehiculeGestionnaireService vehiculeService ;
        @Autowired
        private TypeClientGestionnaireService typeClientService ;
        @Autowired
