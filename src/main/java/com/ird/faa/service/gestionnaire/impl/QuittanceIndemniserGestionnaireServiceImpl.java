...
@Service
public class QuittanceIndemniserGestionnaireServiceImpl extends AbstractServiceImpl<QuittanceIndemniser> implements QuittanceIndemniserGestionnaireService {

@Autowired
private QuittanceIndemniserDao quittanceIndemniserDao;

        @Autowired
        private DeviseGestionnaireService deviseService ;
