...
import com.ird.faa.service.gestionnaire.facade.SinistreGestionnaireService;
        import com.ird.faa.service.gestionnaire.facade.TypeSinistreGestionnaireService;
...
@Service
public class SinistreGestionnaireServiceImpl extends AbstractServiceImpl<Sinistre> implements SinistreGestionnaireService {

@Autowired
private SinistreDao sinistreDao;

        @Autowired
        private TypeSinistreGestionnaireService typeSinistreService ;
        @Autowired
