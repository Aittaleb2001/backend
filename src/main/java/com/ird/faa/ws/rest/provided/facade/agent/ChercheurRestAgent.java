...
import com.ird.faa.service.agent.facade.ChercheurAgentService;
...
@RestController
@RequestMapping("api/agent/chercheur")
public class ChercheurRestAgent {

@Autowired
private ChercheurAgentService chercheurService;
