...
import com.ird.faa.service.agent.facade.GestionnaireAgentService;
...
@RestController
@RequestMapping("api/agent/gestionnaire")
public class GestionnaireRestAgent {

@Autowired
private GestionnaireAgentService gestionnaireService;
