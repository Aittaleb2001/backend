...
import com.ird.faa.service.chercheur.facade.AdminChercheurService;
...
@RestController
@RequestMapping("api/chercheur/admin")
public class AdminRestChercheur {

@Autowired
private AdminChercheurService adminService;
