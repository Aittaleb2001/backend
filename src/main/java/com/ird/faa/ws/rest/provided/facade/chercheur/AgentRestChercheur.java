...
import com.ird.faa.service.chercheur.facade.AgentChercheurService;
...
@RestController
@RequestMapping("api/chercheur/agent")
public class AgentRestChercheur {

@Autowired
private AgentChercheurService agentService;
