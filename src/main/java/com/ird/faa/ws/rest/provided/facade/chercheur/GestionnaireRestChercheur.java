...
import com.ird.faa.service.chercheur.facade.GestionnaireChercheurService;
...
@RestController
@RequestMapping("api/chercheur/gestionnaire")
public class GestionnaireRestChercheur {

@Autowired
private GestionnaireChercheurService gestionnaireService;
