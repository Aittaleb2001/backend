...
import com.ird.faa.service.gestionnaire.facade.AdminGestionnaireService;
...
@RestController
@RequestMapping("api/gestionnaire/admin")
public class AdminRestGestionnaire {

@Autowired
private AdminGestionnaireService adminService;
